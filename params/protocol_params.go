...
const (
	...
	GenesisGasLimit      uint64 = 12500000 // Gas limit of the Genesis block.
...
var (
	...
	DifficultyBoundDivisor2 = big.NewInt(512)    // The bound divisor of the difficulty, used post hardfork1.
