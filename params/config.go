...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		HomesteadBlock:      big.NewInt(59_999),
		DAOForkBlock:        nil,
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(59_999),
		EIP150Hash:          common.HexToHash("0xa013b1d12477cb417d7212b4809cd89704707ed8eab1d28c960ad7637e68c193"),
		EIP155Block:         big.NewInt(100_000),
		EIP158Block:         big.NewInt(120_000),
		ByzantiumBlock:      big.NewInt(130_000),
		ConstantinopleBlock: big.NewInt(2820000),
		PetersburgBlock:     big.NewInt(2822000),
		IstanbulBlock:       big.NewInt(2824000),
	...
	MainnetCheckpointOracle = &CheckpointOracleConfig{
		Address:   common.HexToAddress("0x926d69cc3bbf81d52cba6886d788df007a15a3cd"),
	...
	TestnetChainConfig = &ChainConfig{
		...
		ByzantiumBlock:      big.NewInt(22000),
		ConstantinopleBlock: big.NewInt(956340),
		PetersburgBlock:     big.NewInt(956350),
		IstanbulBlock:       big.NewInt(956360),
		MuirGlacierBlock:    big.NewInt(956370),
